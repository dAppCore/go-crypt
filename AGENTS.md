...
- Four independent top-level packages: `crypt/` (symmetric/asymmetric primitives), `auth/` (OpenPGP + password authentication), `trust/` (3-tier capability access control), `keys/` (sealed-key service, tiered AEAD blobs at rest).
